            ...
            if (typeof json === "object") {
                if (json instanceof Array === false) {
                    ...
                    if (json[ths.option.listname] && json[ths.option.listname].length > 0) {
						var tmp = ct;
                        tmp = tmp.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\"/g,"&quot;").replace(/\'/g,"&#39;").replace(/\//g,"&#47;");
                        html += "<div class='tree-node' nodeid='" + i + "'>" +
                                ...
                                "<span class='title' data-bind='click:title'>" + tmp + "</span></div><div class='tree-node-list'>";
...
//            {name: "添加", title: "添加", type: "add", icon: "fa fa-plus"}
        ...
        var cfn = function (json, c) {
            if (typeof json === "object") {
                if (json instanceof Array === false) {
                    ...
                    if ((json[ths.option.listname]) !== null && (json[ths.option.listname])&&(json[ths.option.listname]).length > 0) {
                    	var tmp = ct;
                        tmp = tmp.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\"/g,"&quot;").replace(/\'/g,"&#39;").replace(/\//g,"&#47;");
                    	html += "<div class='xnode' nodeid='" + i + "'>" +
                                ...
                                (json[ths.option.iconname] ? "<div class='icon'><i class='" + json[ths.option.iconname] + "'></i></div>" : "") +
                                "<span class='title'>" + tmp + "</span></div><div class='xnode-list'>";
                        arguments.callee(json[ths.option.listname]);
                    } else {
                        if (ths.option.async) {
                        	var tmp = ct;
        ...
        dom.find(".title").each(function () {
            $(this).click(function () {
                ...
                if ($(this).parent().find(".tools").length === 0) {
                    var str = "<div class='tools'>";
                    if (ths.option.level >= lev && ths.option.isadd) {
                        str += "<div class='tool' type='add' title=''><i class='fa fa-plus'></i></div>";
                    }
                    if (lev > 2 && ths.option.isremove) {
                        str += "<div class='tool' type='remove' title=''><i class='fa fa-times'></i></div>";
                    }
                    if (ths.option.ismoveup) {
                        str += "<div class='tool' type='moveup' title=''><i class='fa fa-caret-up'></i></div>";
                    }
                    if (ths.option.ismovedown) {
                        str += "<div class='tool' type='movedown' title=''><i class='fa fa-caret-down'></i></div>";
                    }
                    if (ths.option.isedit) {
                        str += "<div class='tool' type='edit' title=''><i class='fa fa-pencil'></i></div>";
                    }
    ...
    addNode: function (json) {
        if (this.current) {
            ...
            var tmp = json[this.option.showname];
            tmp = tmp.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\"/g,"&quot;").replace(/\'/g,"&#39;").replace(/\//g,"&#47;");
            var html = "<div class='xnode' nodeid='" + i + "'>" +
                    ...
                    "<span class='title'>" + tmp + "</span></div><div class='xnode-list'></div></div>";
            var c = $(html).appendTo(this.current.parent().children(1));
            this.setTree(c);
        }
        return this;
